// Simula a entrada de dados (você pode adaptar isso para usar módulos como 'readline-sync' para interativi
const notas = {
...
function calcularMedia (notasBimestrais) {
  const somaNotas = notasBimestrais.primeiroBimestre +
                    notas Bimestrais.segundoBimestre +
                    notas Bimestrais.terceiroBimestre +
                    notas Bimestrais.quartoBimestre;
