...
// Acessando elementos do array (a contagem começa em B)
console.log("A primeira fruta é:", frutas[0]); // Saida: A primeira fruta é: Maçã
console.log("A terceira fruta é:", frutas [2]); // Saida: A terceira fruta e: Laranja
...
frutas.push("Morango");
console.log("O array agora é:", frutas); // Saida: O array agora é: [ 'Maça', 'Banana', 'Laranja', 'Uva', 'Morango"]

//Removendo o último elemento do array
frutas.pop();
console.log("O array após remover o último elemento:", frutas); // Saida. O array após remover o último elemento:
